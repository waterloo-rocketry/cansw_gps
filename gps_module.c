...
void enqueue_can_msgs_alt(uint32_t timestamp) {
	...
	// within a byte
	build_gps_alt_msg(PRIO_HIGH, millis(), (uint16_t)alt, (uint8_t)(dalt / 100), &msg_alt);
	txb_enqueue(&msg_alt);
}
